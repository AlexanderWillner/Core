...
\makeatletter
\g@addto@macro\@mn@margintest{% chktex 21
  \if@twocolumn%
    \ifx\@mn@currxpos\relax% don't know which margin use normal one chktex 21
      \normalmarginpar%
    \else\ifx\@mn@currxpos\@empty% don't know which margin use normal one chktex 21
        \normalmarginpar%
      \else
        \if@tempswa% use \oddsidemargin for tests
          \ifdim\@mn@currxpos\ >\dimexpr\ \oddsidemargin+1in+\columnwidth\relax% chktex 21
            \normalmarginpar% right column --> right margin
          \else
            \reversemarginpar% left column --> left margin
          \fi
        \else% use \evensidemargin for tests
          \ifdim\@mn@currxpos\ >\dimexpr\ \evensidemargin+1in+\columnwidth\relax% chktex 21
